...
public class SecureTextCaptchaHandlerTest {
	...
	public void testGenerateGenericLengthZero() {
		assertThrows(IllegalArgumentException.class, () -> {
			handler.generate(0, cipherHandler,"", password, generator, renderer, 1, 1, true);
		});
	}
	...
	public void testGenerateGenericLengthNegative() {
		assertThrows(IllegalArgumentException.class, () -> {
			handler.generate(-1, cipherHandler,"", password, generator, renderer, 1, 1, true);
		});
	}
	...
	public void testGenerateGenericNegativeHeight() {
		assertThrows(IllegalArgumentException.class, () -> {
			handler.generate(1, cipherHandler,"", password, generator, renderer, -3, 1, true);
		});
	}
	...
	public void testGenerateGenericIllegalWidth() {
		assertThrows(IllegalArgumentException.class, () -> {
			handler.generate(1, cipherHandler,"", password, generator, renderer, 3, 0, true);
		});
	}
	...
	public void testGenerateGenericNull() {
		assertThrows(IllegalArgumentException.class, () -> {
			handler.generate(10, cipherHandler,null, password, null, null, 60, 300, true);
		});
	}
	...
	public void testValidateEmptyString() {
		assertThrows(IllegalArgumentException.class, () -> {
			handler.toCaptcha("", cipherHandler,dummySerializable, password, new SimpleTextImageRenderer(), 60, 300, true);
		});
	}

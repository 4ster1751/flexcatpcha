...
public class CipherHandler {
     ...
     */
    public final byte[] encryptString(byte[] input, String password, Serializable saltSource) {
     ...
     * @return the encrypted string
     */
    public final byte[] encryptString(byte[] input, String password, Serializable saltSource, byte[] ivBytes) {
     ...
     */
    public final byte[] decryptString(byte[] input, String password, Serializable saltSource) {
        if (StringUtils.isEmpty(password)) {
            throw new IllegalArgumentException("The supplied password is empty or null. Encryption can not proceed.");
        }
        try {
